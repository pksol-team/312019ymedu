...
class Weblator_Polling {
        ...
        $wpdb->query(
            $wpdb->prepare("
                ...
                `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
                  ...
                  PRIMARY KEY (`id`)
                ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1", array()));
	...
	public function enqueue_scripts() {
        wp_enqueue_script( $this->plugin_slug . '-excanvas', plugins_url( 'assets/js/vendors/excanvas.js', __FILE__ ), array( 'jquery' ), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-chartjs', plugins_url( 'assets/js/vendors/Chart.min.js', __FILE__ ), array( 'jquery' ), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-legend', plugins_url( 'assets/js/app/legend.js', __FILE__ ), array( 'jquery' ), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-plugin-script', plugins_url( 'assets/js/app/public.js', __FILE__ ), array( 'jquery', $this->plugin_slug . '-legend' ), self::VERSION );
