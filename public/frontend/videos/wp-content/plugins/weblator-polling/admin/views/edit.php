<div class="wrap weblator-admin">
    ...
    <div class="shortcodes">
        Shortcode example: <code>[poll id="<?php echo $poll->id; ?>"]</code><br>
        Template files usage example: <code><?php echo htmlentities("<?php echo do_shortcode(\"[poll id="); echo $poll->id;  echo htmlentities("]\"); ?>"); ?></code><br>
                    ...
                    <div class="inside">
                        <table class="form-table editcomment poll-settings">
                            ...
                            <tr valign="top">
                                ...
                                <td><input type="text" name="weblator_polling_name" size="30" id="name" value="<?php echo stripslashes($poll->poll_name); ?>"></td>
                            </tr>
                                ...
                                <td>
                                    <select name="weblator_polling_chart_type" id="weblator_polling_chart_type">
                                        ...
                                        <?php foreach($charts as $chart): ?>
                                            <option value="<?php echo $chart->id; ?>" <?php echo ($poll->poll_chart_type == $chart->id) ? "selected='selected'" : ""; ?>><?php echo $chart->chart_type; ?></option>
                                        <?php endforeach; ?>
                            ...
                            <tr valign="top" class="option_hide">
                                ...
                                <td class="">
                                    <input type="text" name="poll_max_width" size="30" id="poll_max_width" value="<?php echo $poll->poll_max_width; ?>">
                            ...
                            <tr valign="top" class="option_hide legend-option-secondary">
                                ...
                                <td class="fill colour-option">
                                    <div style="position: relative;">
                                        <input type="text"name="chart_legend_font_colour" class="poll-colour" size="30" value="<?php echo (isset($poll->chart_legend_font_colour)) ? $poll->chart_legend_font_colour : "rgb(102, 102, 102)"; ?>">
                                    </div>
                                </td>
                    ...
                    <div class="inside">
                        <table class="form-table editcomment poll-options">
                            ...
                            <tr valign="top" data-order="<?php echo $key+1; ?>">
                                    ...
                                    <td>
                                        <input type="text"name="poll_option" class="poll-option" size="30" data-id="<?php echo $option["id"]; ?>" value="<?php echo stripslashes($option["option_value"]); ?>">
                                    </td>
                                    <td class="fill colour-option">
                                        <div style="position:relative">
                                            <input type="text"name="poll_colour" class="poll-colour" size="30" value="<?php echo $option["option_colour"]; ?>">
                                        </div>
                                    </td>
                        ...
                        <div class="submitbox" id="submitcomment">
                            ...
                            <div id="major-publishing-actions">
                                ...
                                <div id="publishing-action">
                                    <input type="submit" name="save" data-poll-id="<?php echo $poll->id; ?>" id="save" class="button button-primary save-button edit" value="Update">
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div>
                        ...
                        <div class="submitbox" id="submitcomment">
                            <div id="minor-publishing" style="padding:10px;">
                                ...
                                <?php foreach($options as $key => $option): ?>
                                    ...
                                    <strong><?php echo stripslashes($option["option_value"]); ?></strong>
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo $p; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $p; ?>%;">
                                            <span class="sr-only"><?php echo $option["votes"]; ?></span>
                                        </div>
                                    </div>
