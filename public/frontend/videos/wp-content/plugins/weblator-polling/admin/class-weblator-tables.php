...
class Weblator_Tables extends WP_List_Table {
    ...
    function get_table_classes(){
        ...
        return array("widefat", "fixed", "polls", "weblator_table");
    }
    ...
    function column_poll_name($item){
        $actions = array(
            ...
            'delete'    => sprintf('<a href="?page=%s&action=%s&delete_poll=%s" class="delete_poll" data-poll-id="%s">Delete</a>',$_REQUEST['page'],'delete',$item['id'], $item['id']),
        );
    ...
    function prepare_items() {
        ...
        if (isset($_POST["s"]))
            $query .= " AND poll_name LIKE '%" . mysql_real_escape_string($_POST["s"]). "%'";
