...
class EmployeesController extends Controller
{
	...
	public $listing_cols = ['id', 'name', 'role', 'gender', 'mobile', 'email', 'city'];
...
public function store(Request $request)
	...
	public function update(Request $request, $id)
	{
		if(Module::hasAccess("Employees", "edit")) {
			...
			$userRole = DB::table('role_user')->where('user_id',$id)->update(array(
...
// 		$values = DB::table('employees')->select($this->listing_cols)->whereNull('deleted_at')->where([['role', '!=', '3'], ['role', '!=', '1']]);
        $values = DB::table('employees')->select($this->listing_cols)->whereNull('deleted_at')->where('role', '!=', '3');
