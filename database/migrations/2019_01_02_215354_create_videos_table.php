...
class CreateVideosTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Videos", 'videos', 'title', 'fa-video-camera', [
            ["title", "Title", "String", false, "", 0, 256, true],
            ["description", "Description", "Textarea", false, "", 0, 0, false],
            ["vimeo_link", "Vimeo Link", "Integer", false, "", 0, 11, false],
            ["file", "File", "File", false, "", 0, 0, false],
            ["video_option", "Select Video Option", "Dropdown", false, "", 0, 0, false, ["vimeo","file"]],
            ["instructor", "Instructor", "Dropdown", false, "", 0, 11, false, "@employees"],
        ]);
