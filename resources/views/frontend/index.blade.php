                                    ...
                                    <div class="aligncenter">
                                      <a href="/single_course/<?= $courses[1]->id ?>">
                                         ...
                                         ?>    
                                          ...
                                          <!--<img src="/frontend/images/product2.png" alt="image description"></a>-->
                                    </div>
                                    <div class="pp-post-bottim">
                                      <h3 class="post-heading"><a href="/single_course/<?= $courses[1]->id ?>">{{ $courses[1]->name }}</a></h3>
                                        <footer class="post-foot gutter-reset">
                                            <?php
                            ...
                            <div class="aligncenter">
                              <a href="/single_course/<?= $courses[2]->id ?>">
                                 ...
                                 ?>    
                                  ...
                                  <!--<img src="/frontend/images/watch_video.jpg" alt="image description"></a>-->
                            </div>
                            <div class="pp-post-bottim">
                              <h3 class="post-heading"><a href="/single_course/<?= $courses[2]->id ?>">{{ $courses[2]->name }}</a></h3>
                                <footer class="post-foot gutter-reset">
                                   <?php
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                          <article class="popular-post">
                            ...
                            <div class="pp-post-bottim">
                              <h3 class="post-heading"><a href="/single_course/<?= $courses[3]->id ?>">{{ $courses[3]->name }}</a></h3>
                                <footer class="post-foot gutter-reset">
                                     <?php
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                          <article class="popular-post">
                            ...
                            <div class="pp-post-bottim">
                              <h3 class="post-heading"><a href="/single_course/<?= $courses[4]->id ?>">{{ $courses[4]->name }}</a></h3>
                                <footer class="post-foot gutter-reset">
                                   <?php
