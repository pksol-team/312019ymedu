<head>
    ...
    <link href="{{ asset('la-assets/plugins/summernote-master/dist/summernote.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('la-assets/css/tagsinput.css') }}" rel="stylesheet" type="text/css">
