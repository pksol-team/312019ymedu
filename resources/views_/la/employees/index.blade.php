...
@section("contentheader_title", "Instructors")
@section("contentheader_description", "Instructors listing")
@section("section", "Employees")
@section("sub_section", "Listing")
@section("htmlheader_title", "Instructors Listing")

@section("headerElems")
@la_access("Employees", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Instructor</button>
@endla_access
@endsection
