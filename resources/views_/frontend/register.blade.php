   ...
   <div id="two-columns" class="container">
      <div class="row">
         ...
         <article id="content" class="col-xs-12 col-md-12">
            <!-- content h1 -->
            <h1 class="content-h1 fw-semi">Register</h1>
            <!-- view header -->
                  ...
                  <div class="col-xs-12 col-md-12">
                     ...
                     <form method="post" action="/frontend/register_check" class="user-log-form">
                        ...
                        <div class="form-group">
                           <input value="{{ old('first_name') }}" name="first_name" type="text" class="form-control element-block" placeholder="First Name *" required>
                        </div>
                        <div class="form-group">
                           <input value="{{ old('last_name') }}" name="last_name" type="text" class="form-control element-block" placeholder="Last Name *" required>
                        </div>
                        <div class="form-group">
